    ...
    <div className="min-h-screen bg-[#10141a] text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Contact Form */}
          <div className="bg-[#181c23] p-8 rounded-xl shadow-lg border border-[#232a36]">
            <ContactForm title="Send us a Message" purpose="general" />
          </div>
          ...
          <div className="bg-[#181c23] p-8 rounded-xl shadow-lg border border-[#232a36]">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">info@alphaargons.com</p>
                  <p className="text-gray-300">support@alphaargons.com</p>
                </div>
              </div>
            ...
            {/* Social Media */}
            <div className="mt-8 pt-6 border-t border-[#232a36]">
